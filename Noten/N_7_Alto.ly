...
KyrieIAltoNotes = {
	\relative c' {
		...
		g1
		g2 r \bar "||" %39 finis
		\tempoKyrieIC g8.^\tutti g16 g8 g a4 g8 f %40
		e([ f e d] c[ d e fis])
		g4 r8 c h([ a)] g f
		e([ f e d] c[ d e fis])
...
DomineFiliAltoNotes = {
	\relative c' {
		\clef treble
		\key e \minor \time 2/4 \autoBeamOff \tempoDomineFili
...
CumSanctoAltoNotes = {
	\relative c' {
		...
		fis4. h,8 \once \stemUp h'2
		gis a)
		fis4 \once \stemUp h( e, a
...
% 		\time 6/4 r4 b es c( f es % for MIDI
		...
		g[ f es f g a] \once \stemUp b4) b, r
		r1*3/4 r4 c' b
		as2 g4 r f es
		d( c fis g4. f?8 es4~)
